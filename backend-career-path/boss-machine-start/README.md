...
The instruction below were provided by Codecademy as a guide to complete the project. The front end has been provided and the purpose of this project was to reinforce competence in building a server withe Node and Express. 
